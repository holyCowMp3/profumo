...
export default class OrderRow extends React.Component {
  ...
  render() {
    if (this.state.ready)
      return (
        <tr>
          <td style={{border: '1px solid #E3E9F3', 'boxShadow' : '0px 1px 1px rgba(104, 118, 142, 0.05)'}}>{this.props.index}</td>
          ...
          <td style={{border: '1px solid #E3E9F3', 'boxShadow' : '0px 1px 1px rgba(104, 118, 142, 0.05)'}}>{this.state.data.price} грн.</td>
          <td style={{border: '1px solid #E3E9F3', 'boxShadow' : '0px 1px 1px rgba(104, 118, 142, 0.05)'}}>{this.props.count}</td>
          <td style={{border: '1px solid #E3E9F3', 'boxShadow' : '0px 1px 1px rgba(104, 118, 142, 0.05)'}}>{this.state.data.price * this.props.count} грн.</td>
        </tr>
      )
    return ''
  }
